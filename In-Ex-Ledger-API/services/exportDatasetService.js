...
function buildNormalizedRow(enrichedTxn, context) {
  ...
  const row = {
    ...
    categoryName,
    categoryMappingReason: String(enrichedTxn.category_mapping_reason || enrichedTxn.categoryMappingReason || "").trim(),
    categoryMappingConfidence: String(enrichedTxn.category_mapping_confidence || enrichedTxn.categoryMappingConfidence || "").trim(),
    categoryMappingRuleId: enrichedTxn.category_mapping_rule_id || enrichedTxn.categoryMappingRuleId || "",
