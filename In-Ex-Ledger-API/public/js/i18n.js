...
const TRANSLATIONS = {
  en: {
    ...
    landing_hero_title: 'Simple accounting for 1099 workers and independent contractors',
    ...
    landing_included_item1: 'Account creation & secure sign-in',
    landing_included_item2: 'Private business ledger per user',
    landing_included_item3: 'Income & expense tracking',
    landing_included_item4: 'Basic transaction organization',
    landing_included_item5: 'CSV export for tax preparation',
    landing_included_item6: '30-day free trial (then choose a plan)',
    ...
    landing_coming_item1: 'Bank sync (automatic transaction imports)',
    landing_coming_item2: 'Smarter categorization suggestions',
    landing_coming_item3: 'Receipt capture improvements',
    landing_coming_item4: 'More exports & reporting options',
