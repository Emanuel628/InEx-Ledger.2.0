const LANDING_REGION_COPY = {
  US: {
    ...
    featureRegionTitle: "Built for U.S. businesses",
    featureRegion: "Includes U.S. business categories, 1099 income, receipts, mileage, and exports.",
  ...
  CA: {
    ...
    featureRegionTitle: "Built for Canadian businesses",
    featureRegion: "Includes Canadian business categories, T4A details, GST/HST support, receipts, kilometres, and exports.",
