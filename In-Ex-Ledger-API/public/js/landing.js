const LANDING_REGION_COPY = {
  US: {
    ...
    regionSectionSubtitle: "Schedule C categories, 1099 income context, mileage, receipts, and exports.",
  ...
  CA: {
    ...
    regionSectionSubtitle: "T2125 categories, T4A context, GST/HST category support, kilometres, receipts, and exports.",
