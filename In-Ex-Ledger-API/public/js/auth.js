...
function maybeLoadOnboardingRuntime(profile = {}) {
  ...
  if (!document.querySelector('script[src*="onboarding.js"]')) {
    ...
    script.src = "/js/onboarding.js?v=20260606a";
...
function initAccountMenus(displayName = authT("common_user"), profile = {}) {
  ...
  document.querySelectorAll(".user-pill").forEach((pill, index) => {
    ...
    menu.innerHTML = `
      ...
      <a href="/settings" class="account-menu-item" data-account-menu-link="settings" role="menuitem">
        <span class="account-menu-label">${typeof t === "function" ? t("nav_settings") : "Settings"}</span>
      </a>
