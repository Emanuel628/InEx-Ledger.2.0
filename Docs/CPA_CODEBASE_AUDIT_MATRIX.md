...
| Vehicle deductions and support | `services/vehicleClaimService.js`, `routes/vehicleClaims.routes.js`, `legacy/public-html/auth-public/compliance-dashboard.html` | `vehicleClaimService.test.js`, `reviewQueueRoutes.test.js` | `partial` |
